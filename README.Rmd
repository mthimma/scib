...
The goal of scib (single-cell integration and benchmarking) package is to provide a unified way to perform data integration and benchmarking when the ground truth is available.
